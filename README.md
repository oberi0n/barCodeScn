...
This repository hosts a two-tab progressive web app (PWA) that scans barcodes/QR codes, routes payloads to one of two secured webhooks, and keeps a same-day history. The UI follows the clean, light aesthetic of labo.lu. Current version: **0.3.6**.
...
### 0.3.6
- Optimized the interface, scanner, history, and settings for iPhone 14 portrait and iOS safe areas.
- Added distinct detection, delivery-success, and delivery-error scan sounds.
